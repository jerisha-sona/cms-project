        ...
        >
            ...
            <header className="absolute top-0 left-0 w-full flex justify-between items-center px-8 py-4 bg-transparent z-20">
                ...
                <nav className="flex space-x-6">
                    <Link to="/" className="text-white font-semibold hover:text-purple-300 transition">Home</Link>
                    <Link to="/" className="text-white font-semibold hover:text-purple-300 transition">Login</Link>
